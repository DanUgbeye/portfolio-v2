...
export default function InterestButton(props: InterestButtonProps) {
  return (
    <button
      ...
      } text-left rounded-lg w-full h-8 sm:h-10 sm:px-4 sm:border-2 text-xs before:max-h-2.5 before:rounded-sm before:outline-1 before:px-2 before:aspect-square before:mr-2 before:outline before:border-4 before:border-deep-blue-700 sm:before:hidden transition-colors duration-200 sm:flex sm:justify-center sm:items-center  `}
      type="button"
